...
export { navItems, footerItems } from './siteConfig'
export * from './friends'
...
export const headline = 'AI Product Manager'
export const introduction = 'AI Agent × 产品设计 × 技术落地。软件工程背景，具备 AI Agent、RAG、AI SaaS 产品实践经验，擅长从业务需求分析到产品落地完整推进 AI 应用。'
...
// about page
export const aboutMeHeadline = "我是金旻，一个能把业务需求变成 AI 产品的产品经理。"
export const aboutParagraphs = [
  "我拥有软件工程学术背景，先后在上海建桥学院完成计算机科学技术和软件工程的学习。扎实的工程基础让我能够深入理解技术可行性，在与研发团队协作时高效沟通。",
