...
export const headline = '软件工程背景 × AI Agent 实战经验'
export const introduction = '专注于企业 AI 应用的产品设计、解决方案与技术落地。从真实业务场景出发，参与 AI Agent、企业效率工具和海外 SaaS AI 产品建设。'
...
// about page
export const aboutMeHeadline = "我是金旻，专注于企业 AI 应用的产品设计、解决方案与技术落地。"
